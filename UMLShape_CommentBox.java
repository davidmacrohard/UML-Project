...
/**
 * Handles the creation and behavior of comment boxes on the canvas.
 * 
...
public class UMLShape_CommentBox extends UMLShape {
	...
	private UMLShape_Class_PopupMenu popupMenu = null; // Used for the popup
														// menu
	...
	public void mouseClicked(MouseEvent e) {
		...
		// Only if the left mouse button was clicked, do we update the "focus"
		// window
		// Can change to right mouse also? or middle and popup a menu popup?
	...
	public void setUMLShape_Location(double x, double y) {
		...
		// ensure that we have a fluid motion of dragging as the cursor will
		// always
	...
	public void paintComponent(Graphics g) {
		 ...
		 * Font.PLAIN,12); g2D.setFont(font); g2D.drawString("Hello", 4+1, 12);
		 */
