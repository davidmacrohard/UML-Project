...
/**
 * Popup menu that appears when right clicking on a class diagram
 * 
 * @author Team MacroHard
 *
 */
@SuppressWarnings("serial")
public class UMLShape_Class_PopupMenu extends JPopupMenu implements
		ActionListener {
	...
	UMLShape_Class_PopupMenu(UMLShape parent) {
		...
		menu_Edit.getAccessibleContext().setAccessibleDescription(
				"Edit UML Class");
