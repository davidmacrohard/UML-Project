...
/**
 * Handles the toolbar on the left of the screen. User selects objects to place
 * on the canvas from this toolbar.
 * 
...
public class UMLToolBar extends JToolBar implements ActionListener {
	...
	UMLToolBar(String name, int type) {
		...
		// TODO Add actionListener for toggle buttons so if one is selected and
		// then
		// another toggle button is selected, we ensure all toggle buttons are
		// de-toggled
		...
		// TODO Add rest of "getUMLShape_**** toggle buttons - or just add an
		// array list and
		// iterate over it checking the state of the current indexed
		// togglebutton

		// TODO Add ability to "lock" the toolbar and allow it to be "floatable"
		// by changing
